...
public class BitonicArray {
    // desc: true: left increasing or false: right decreasing
    ...
    private static boolean find(int[] array, int target, int peak) {
        return bitonicSearch(array, 0, peak, target, true) || bitonicSearch(array, peak, array.length - 1, target, false);
    }
